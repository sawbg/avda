...
Definition at line \hyperlink{fileio_8hpp_source_l00244}{244} of file \hyperlink{fileio_8hpp_source}{fileio.\+hpp}.
...
00258                 + std::to\_string(params[Side::Left].freq) 
00259                 + \textcolor{stringliteral}{", "} + std::to\_string(params[Side::Left].noise) << std::endl;
00260         \}
00261 
...
00265                 + std::to\_string(params[Side::Right].freq) 
00266                 + \textcolor{stringliteral}{", "} + std::to\_string(params[Side::Right].noise) << std::endl;
00267         \}
00268 
